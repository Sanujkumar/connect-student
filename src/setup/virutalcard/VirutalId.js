    ...
    <div >
     {
      ...
      (<button  className='flex justify-center w-full bg-white text-black text-sm text-center rounded-t-xl border font-semibold hover:bg-slate-50 hover:scale-105 cursor-pointer p-2'
      onClick={clickHandle}
